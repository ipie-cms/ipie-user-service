 ...
 * requirement. Implements {@link PillarIdpWriteBack}. Separate from the token-exchange port
 * since it's a different concern: an
 ...
 */
@Component
public class HttpPillarIdpAdminClient implements PillarIdpWriteBack {

    private final RestClient restClient;
    private final PillarLinkingProperties properties;

    public HttpPillarIdpAdminClient(RestClient.Builder restClientBuilder, PillarLinkingProperties properties) {
