...
class RabbitUserEventLogConsumerTest {
    ...
    private final RabbitUserEventLogConsumer consumer =
            new RabbitUserEventLogConsumer(processedEventStore, auditTrailRepository, objectMapper);
    ...
    void onEvent_persistsAnAuditTrailRow_whenTheEventIsAnAuditEvent() {
        ...
        verify(auditTrailRepository).save(any(AuditTrailJpaEntity.class));
    }
